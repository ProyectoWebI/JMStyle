              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <li><a class="dropdown-item" href="pages/productos.php">Disponibles</a></li>
                              <li><hr class="dropdown-divider"></li>
                              <li><a class="dropdown-item" href="pages/prod_Damas.php">Damas</a></li>
                              <li><a class="dropdown-item" href="pages/prod_Caballeros.php">Caballeros</a></li>
                              <li><hr class="dropdown-divider"></li>
                              <li><a class="dropdown-item" href="pages/prod_Accesorios.php">Accesorios</a></li>
                              <li><a class="dropdown-item" href="pages/prod_Deportivo.php">Deportivo</a></li>
                              <li><a class="dropdown-item" href="pages/prod_Zapatos.php">Zapatos</a></li>
                            </ul>
                          </li>
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="pages/acerca.php" id="navbarDropdown">Acerca de</a>
  ...
  <div class='row'>
    <div class='col-md-4 divBor' style='padding-top: 3rem;'>
      <nav class='nav flex-column'>
        ...
        <a href='pages/acerca.php'>Acerca de</a>
      </nav>
    </div>
